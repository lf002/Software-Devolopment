...
print('Mr. Sekol is the coolest teacher in the galaxy. Ask Mr. Wright.')

#Variables - These can change value based on user input or you can just assign a value to them. 
player_name = "Steve"
print(player_name)
#Concatenation = Combine String + Variables to form an output.
print(f"Welcome, {player_name}, it's great to have you here.")
