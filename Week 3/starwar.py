...
occupation = input("What does your character do for work? ")
weapon = input("What does your character use to defend themselves with? ")
home_planet = input("Which planet does your character come from? ")
sidekick = input("Who is your characters sidekick, and whats his name? ")

print("\n--------- STARS WARS CHARACTER BIO ----------")
